...
RSpec.describe 'DummyOperations API', type: :request do
  ...
  describe 'POST /dummy_operations' do
    # valid payload
    let(:valid_attributes) { {dummy_operation: { title: 'Learn Elm', input: {waferMap: {id: 'ec219dc0-2547-0137-274b-02d7ac46faeb', waferID: 'Wafer123', valType: 'OverlayRaw' ,exposedFields: [], waferPoints: [], waferPointsCount: "10", waferMetrologyStepId: "100", exposedFieldsCount: "100", parentId: nil}}}} }
    let(:valid_attributes2) { {dummy_operation: { title: 'Learn Elm', input: {waferMap: {id: 'ec219dc0-2547-0137-274b-02d7ac46faeb', waferID: 'Wafer123', valType: 'OverlayRaw' ,exposedFields: [{id: 1, width: 34.3, height: 45.5, posX: 3, diam: 300, posY: 5, scan: 'Upwards', scanPath: 'Left'}], waferPoints: [], waferPointsCount: "10", waferMetrologyStepId: "100", exposedFieldsCount: "100", parentId: nil}}}} }

    context 'when the request is valid' do
      before { post '/dummy_operations', params: valid_attributes }
    ...
    context 'when the request is valid with more params' do
      before { post '/dummy_operations', params: valid_attributes2 }
    ...
    context 'when the request is invalid' do
      before { post '/dummy_operations', params: { dummy_operation: { title: ""} } }
